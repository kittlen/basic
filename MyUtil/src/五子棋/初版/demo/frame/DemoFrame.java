...
public class DemoFrame extends javax.swing.JFrame {
	...
	public void paint(Graphics g) {
		...
		/*
		 * img - 要绘制的指定图像。如果 img 为 null，则此方法不执行任何操作。 x - x 坐标。 y - y 坐标。 observer -
		 * 转换了更多图像时要通知的对象。
		 */

		/*
		 * img - 要绘制的指定图像。如果 img 为 null，则此方法不执行任何动作。 x - x 坐标。 y - y 坐标。 width - 矩形的宽度。
		 * height - 矩形的高度。 observer - 当转换了更多图像时要通知的对象
		 */
				...
				if (df.vqpan[i][j] == 0) {
					...
					for (int q = 0; q < 15; q++) {
						for (int w = 0; w < 15; w++) {///// 添加判断输赢代码
							if (df.vqpan[q][w] == 1 && df.vqpan[q][w + 1] == 1 && df.vqpan[q][w + 2] == 1
									&& df.vqpan[q][w + 3] == 1 && df.vqpan[q][w + 4] == 1
									|| df.vqpan[q][w] == 1 && df.vqpan[q + 1][w] == 1 && df.vqpan[q + 2][w] == 1
											&& df.vqpan[q + 3][w] == 1 && df.vqpan[q + 4][w] == 1
									|| df.vqpan[q][w] == 1 && df.vqpan[q + 1][w + 1] == 1 && df.vqpan[q + 2][w + 2] == 1
											&& df.vqpan[q + 3][w + 3] == 1 && df.vqpan[q + 4][w + 4] == 1
									|| df.vqpan[q][w] == 1 && df.vqpan[q + 1][w - 1] == 1 && df.vqpan[q + 2][w - 2] == 1
											&& df.vqpan[q + 3][w - 3] == 1 && df.vqpan[q + 4][w - 4] == 1) {
					...
					for (int qq = 0; qq < 15; qq++) {
						for (int ww = 0; ww < 15; ww++) {
							if (g == true) {// 计算机虚拟棋盘落黑子
								try {
									if (df.vqpan[qq][ww] == 1 && df.vqpan[qq][ww + 1] == 1 && df.vqpan[qq][ww + 2] == 1
											&& df.vqpan[qq][ww + 3] == 2) {
										df.vqpan[qq][ww - 2] = 2;
										g = false;
										break;// 4
									}
									if (df.vqpan[qq][ww] == 1 && df.vqpan[qq + 1][ww] == 1 && df.vqpan[qq + 2][ww] == 1
											&& df.vqpan[qq + 3][ww] == 2) {
										df.vqpan[qq - 2][ww] = 2;
										g = false;
										break;// 4
									}
									if (df.vqpan[qq][ww] == 1 && df.vqpan[qq + 1][ww + 1] == 1
											&& df.vqpan[qq + 2][ww + 2] == 1 && df.vqpan[qq + 3][ww + 3] == 2) {
										df.vqpan[qq - 2][ww - 2] = 2;
										g = false;
										break;// 4
									}
									if (df.vqpan[qq][ww] == 1 && df.vqpan[qq + 1][ww - 1] == 1
											&& df.vqpan[qq + 2][ww - 2] == 1 && df.vqpan[qq + 3][ww - 3] == 2) {
										df.vqpan[qq + 2][ww - 2] = 0;
										g = false;
										break;// 4
									}
									if (df.vqpan[qq][ww] == 1 && df.vqpan[qq - 1][ww + 1] == 1
									...
									if ((df.vqpan[qq][ww] == 1 && df.vqpan[qq][ww + 1] == 1
											&& df.vqpan[qq][ww + 2] == 1) && df.vqpan[qq][ww + 3] == 0) {
										df.vqpan[qq][ww + 3] = 2;
										g = false;
										break;// 3
									}
									...
									if (df.vqpan[qq][ww] == 1 && df.vqpan[qq + 1][ww + 1] == 1
											&& df.vqpan[qq + 2][ww + 2] == 1 && df.vqpan[qq + 3][ww + 3] == 0) {
										df.vqpan[qq + 3][ww + 3] = 2;
										g = false;
										break;// 3
									}
									if (df.vqpan[qq][ww] == 1 && df.vqpan[qq + 1][ww - 1] == 1
											&& df.vqpan[qq + 2][ww - 2] == 1 && df.vqpan[qq + 3][ww - 3] == 0) {
										df.vqpan[qq + 3][ww - 3] = 0;
										g = false;
										break;// 3
									}
									if (df.vqpan[qq][ww] == 1 && df.vqpan[qq - 1][ww + 1] == 1
									...
									if (df.vqpan[qq][ww] == 1 && df.vqpan[qq + 1][ww] == 1
											&& df.vqpan[qq + 2][ww] == 0) {
										df.vqpan[qq + 2][ww] = 2;
										g = false;
										break;// 2
					...
					for (int q = 0; q < 15; q++) {
						for (int w = 0; w < 15; w++) {///// 添加判断输赢代码
							if (df.vqpan[q][w] == 2 && df.vqpan[q][w + 1] == 2 && df.vqpan[q][w + 2] == 2
									&& df.vqpan[q][w + 3] == 2 && df.vqpan[q][w + 4] == 2
									|| df.vqpan[q][w] == 2 && df.vqpan[q + 1][w] == 2 && df.vqpan[q + 2][w] == 2
											&& df.vqpan[q + 3][w] == 2 && df.vqpan[q + 4][w] == 2
									|| df.vqpan[q][w] == 2 && df.vqpan[q + 1][w + 1] == 2 && df.vqpan[q + 2][w + 2] == 2
											&& df.vqpan[q + 3][w + 3] == 2 && df.vqpan[q + 4][w + 4] == 2
									|| df.vqpan[q][w] == 2 && df.vqpan[q + 1][w - 1] == 2 && df.vqpan[q + 2][w - 2] == 2
											&& df.vqpan[q + 3][w - 3] == 2 && df.vqpan[q + 4][w - 4] == 2) {
